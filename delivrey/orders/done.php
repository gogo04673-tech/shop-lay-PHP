...
if ($orderId > 0 && $userId > 0) {
    ...
    updateData('orders', $updateData, ["orders_id" => $orderId, "orders_status" => 3]);


    // sendGCM("Success", "Your order is preparing.", "users$userId", "none", "refreshPageOrders");
    insertNotify("Success", "Enjoy with your a order", $userId, "users$userId", "none", "refreshPageOrders");


    sendGCM("Shop-Lay-Service", "The order has been delivered to the user", "service", "none", "none");
